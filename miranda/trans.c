...
{ extern word commandmode,cook_stdin,common_stdin,common_stdinb,rv_expr;
  /* Translation stage: parser output -> runtime combinator form.
   * This is where lambdas/lets/tries/lexers are lowered before reduction. */
  switch(tag[x])
...
void decltype(word tf,word class,word info,word here)
